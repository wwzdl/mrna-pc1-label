...
copy_one "${SUB_DIR}/figures/main/Fig06_ortholog_regularized_target_cn.tiff" "${OUT_DIR}/figures/main/Figure_6.tiff"
copy_one "${SUB_DIR}/figures/main/Fig07_sequence_progression_cn.tiff" "${OUT_DIR}/figures/main/Figure_7.tiff"
copy_one "${SUB_DIR}/figures/main/Fig08_prior_summary_cn.tiff" "${OUT_DIR}/figures/main/Figure_8.tiff"
...
copy_one "${SUB_DIR}/figures/supplement/FigS_tuning_scan.tiff" "${OUT_DIR}/figures/supplement/Online_Resource_1_Figure_S4.tiff"
