...
The public source repository is [wwzdl/mrna-pc1-label](https://github.com/wwzdl/mrna-pc1-label). The audited two-author manuscript state is tagged as `mRNA-PC1-label-v1.4.5`; run the release preflight before deriving any later submission package from a newer commit.
